...
CREATE TABLE "UpdateStep" (
    ...
    CONSTRAINT "UpdateStep_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdateStep" ADD CONSTRAINT "UpdateStep_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
